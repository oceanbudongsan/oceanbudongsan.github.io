...
window.OceanGEO = (function () {
  ...
  function buildPostHtml(post) {
    ...
    return [
      ...
      '<link href="css/ocean-motion.css?v=20260906g" rel="stylesheet">',
      '<link rel="stylesheet" href="common.css?v=20260906g">',
      '<style>',
      ...
      '</div>',
      '',
      '<script src="common.js?v=20260906g" data-bottomnav="off"><\/script>',
      '</body>',
      '</html>',
      ''
